...
exports.updateWithdrawalStatus = async (req, res) => {
  try {
    ...
    const { status, remarks, reference } = req.body;
    ...
    */
    ...
    if (status === "paid") {
      ...
      sendEmail(
        ...
        console.log("Withdrawal Paid Email:", err.message)
      );
      ...
      sendEmail(
        ...
        `
          ...
          <table border="1" cellpadding="8">
            ...
            <tr>
              <td><strong>Reason</strong></td>
              <td>${withdrawal.remarks || "Not provided"}</td>
            </tr>
          ...
          <p>Your wallet has been refunded automatically.</p>

          <p>If you believe this was a mistake, please contact support.</p>
        `
      ).catch(err =>
        console.log("Withdrawal Reject Email:", err.message)
      );
